...
docker cp streamingwars:/usr/src/cs6310/stream_test_initial_${SCENARIO}_results.txt ./test_results/
docker cp streamingwars:/usr/src/cs6310/diff_results_${SCENARIO}.txt ./test_results
